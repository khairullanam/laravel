  ...
  <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
    ...
    <div class="flex flex-col w-full md:w-2/5 justify-center items-center md:items-start text-center md:text-left">
      <h1 class="my-4 text-3xl md:text-5xl font-bold leading-tight">
        HMI Komisariat Paramadina
      </h1>
      <p class="leading-normal text-xl md:text-2xl mb-8">
        "Tentang Rumah, Perjuangan, dan Do'a"
      </p>
      <a href="https://www.youtube.com/@hmiparamadinaofficial8923">
    ...
    <div class="w-full md:w-3/5 py-6 text-center">
      <img class="w-full md:w-4/5 mx-auto z-50" src="img/logo-1.png" />
    </div>
  </div>
</div>
